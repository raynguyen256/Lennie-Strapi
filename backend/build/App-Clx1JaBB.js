...
`,Hs=({folder:e})=>{const n=Ce(),{formatDate:s,formatMessage:r}=S(),{navigateToFolder:o}=Me(),a=i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),o(e))};return t.jsxs(zs,{tabIndex:0,role:"row",onClick:()=>o(e),onKeyDown:a,children:[t.jsx(k,{children:t.jsxs(y,{gap:3,alignItems:"center",children:[t.jsx(y,{justifyContent:"center",alignItems:"center",borderRadius:"4px",color:"neutral600",width:"3.2rem",height:"3.2rem",shrink:0,children:t.jsx(ie,{width:20,height:20})}),t.jsx(w,{textColor:"neutral800",fontWeight:"semiBold",ellipsis:!0,children:e.name})]})}),!n&&t.jsxs(t.Fragment,{children:[t.jsx(k,{children:t.jsx(w,{textColor:"neutral600",children:e.createdAt?s(new Date(e.createdAt),{dateStyle:"long"}):"-"})}),t.jsx(k,{children:t.jsx(w,{textColor:"neutral600",children:e.updatedAt?s(new Date(e.updatedAt),{dateStyle:"long"}):"-"})}),t.jsx(k,{children:t.jsx(w,{textColor:"neutral600",children:"-"})})]}),t.jsx(k,{children:t.jsx(y,{justifyContent:"flex-end",children:t.jsx(G,{label:r({id:u("control-card.more-actions"),defaultMessage:"More actions"}),variant:"ghost",onClick:i=>i.stopPropagation(),children:t.jsx(le,{})})})})]})},qs=({assets:e,folders:n=[],onAssetItemClick:s})=>{const r=Ce(),{formatMessage:o}=S(),a=r?Ee.filter(l=>l.name==="name"||l.name==="actions"):Ee,i=n.length+e.length;return t.jsxs(_s,{colCount:a.length,rowCount:i+1,children:[t.jsx(Gs,{children:t.jsx(xe,{children:a.map(l=>{const f=o(l.label);return"isVisuallyHidden"in l&&l.isVisuallyHidden?t.jsx($e,{children:t.jsx(ae,{children:o({id:u("table.header.actions"),defaultMessage:"actions"})})},l.name):t.jsx($e,{children:t.jsx(w,{textColor:"neutral600",variant:"sigma",children:f})},l.name)})})}),t.jsx(Ut,{children:i===0?t.jsx(xe,{children:t.jsx(Bs,{colSpan:a.length,children:t.jsx(w,{textColor:"neutral600",children:o({id:"app.components.EmptyStateLayout.content-document",defaultMessage:"No content found"})})})}):t.jsxs(t.Fragment,{children:[n.map(l=>t.jsx(Hs,{folder:l},`folder-${l.id}`)),e.map(l=>t.jsx(Vs,{asset:l,onAssetItemClick:s},l.id))]})})]})},Ws=m(P.Content)`
  max-width: 51.6rem;
