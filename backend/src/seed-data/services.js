...
/* Ported from `Web Lennie Design/js/data-services.jsx` (serviceCategories, CAT_DEFAULTS, RAW_SERVICES). */
...
const RAW_SERVICES = [
  ...
  { cat: 'consult', name: 'Soi da & Phân tích chuyên sâu', tagline: 'Đánh giá nền da, độ ẩm và hàng rào lipid bằng thiết bị soi da.', duration: '40 phút', price: '300.000đ', priceNote: 'khấu trừ khi dùng liệu trình', summary: 'Phiên soi da chi tiết giúp bạn hiểu đúng tình trạng làn da: loại da, độ ẩm, mức dầu, sắc tố và tổn thương hàng rào bảo vệ — nền tảng để xây dựng một phác đồ chính xác.' },
  { cat: 'consult', name: 'Theo dõi & Tinh chỉnh phác đồ định kỳ', tagline: 'Đồng hành sát sao, điều chỉnh routine theo từng giai đoạn da.', duration: 'Hàng tuần / Hàng tháng', price: 'Miễn phí', priceNote: 'cho khách đang theo liệu trình', summary: 'Làn da thay đổi theo thời gian và môi trường. Lennie theo dõi tiến triển định kỳ, lắng nghe phản hồi và tinh chỉnh sản phẩm, nồng độ, tần suất để bạn luôn đi đúng hướng.' },
  ...
  /* 2 — Điều trị mụn */
  { cat: 'acne', name: 'Phục hồi da mụn ẩn & Bít tắc', tagline: 'Thông thoáng cổ nang lông, làm sạch nhân mụn ẩn dai dẳng.', duration: '75 phút', price: '750.000đ', priceNote: '/ buổi', summary: 'Liệu trình tập trung làm sạch sâu và thông thoáng cổ nang lông cho da mụn ẩn, sần sùi. Kết hợp dược mỹ phẩm chọn lọc cùng thao tác lấy nhân mụn chuẩn y khoa, hạn chế tổn thương.' },
  { cat: 'acne', name: 'Điều trị mụn viêm & Mụn mủ', tagline: 'Kháng viêm tầng sâu, kiểm soát mụn sưng đỏ, mụn mủ.', duration: '80 phút', price: '850.000đ', priceNote: '/ buổi', summary: 'Phác đồ kháng viêm chuyên sâu cho da mụn viêm, mụn mủ. Giảm sưng đỏ, làm dịu tổn thương và kiểm soát vi khuẩn, hạn chế tối đa nguy cơ thâm và sẹo lõm.' },
  { cat: 'acne', name: 'Kiểm soát dầu & Thu nhỏ lỗ chân lông', tagline: 'Cân bằng tuyến bã nhờn, se khít lỗ chân lông to.', duration: '70 phút', price: '700.000đ', priceNote: '/ buổi', summary: 'Liệu trình cân bằng dầu - nước, làm sạch sâu và se khít lỗ chân lông cho da dầu. Kết hợp hoạt chất kiềm dầu dịu nhẹ giúp da thông thoáng mà không bị khô căng.' },
  { cat: 'acne', name: 'Xử lý thâm & Sẹo sau mụn', tagline: 'Làm mờ thâm đỏ, thâm nâu và cải thiện sẹo rỗ sau mụn.', duration: '85 phút', price: '950.000đ', priceNote: '/ buổi', summary: 'Sau khi mụn ổn định, liệu trình tập trung tái tạo bề mặt, làm mờ vết thâm và cải thiện sẹo rỗ, trả lại làn da mịn màng và đều màu hơn.' },
  { cat: 'acne', name: 'Điều trị mụn lưng & Body', tagline: 'Làm sạch và kháng viêm cho vùng lưng, ngực, vai.', duration: '75 phút', price: '800.000đ', priceNote: '/ buổi', summary: 'Mụn không chỉ ở mặt. Liệu trình điều trị mụn vùng lưng, ngực, vai — làm sạch sâu, kháng viêm và phục hồi, đặc biệt phù hợp trước mùa cưới hoặc dịp diện trang phục hở vai.' },
  ...
  { cat: 'pigment', name: 'Làm mờ tàn nhang & Đốm nâu', tagline: 'Giảm tàn nhang, đốm nâu do nắng, trả lại làn da đều màu.', duration: '75 phút', price: '1.000.000đ', priceNote: '/ buổi', summary: 'Tàn nhang và đốm nâu do tích tụ sắc tố và ánh nắng. Liệu trình làm mờ dần các đốm sắc tố, dưỡng sáng và bảo vệ da khỏi tái hình thành.' },
  { cat: 'pigment', name: 'Dưỡng sáng & Đều màu da', tagline: 'Đánh thức làn da xỉn màu, trả lại vẻ sáng khỏe rạng rỡ.', duration: '70 phút', price: '900.000đ', priceNote: '/ buổi', summary: 'Dành cho làn da xỉn màu, không đều màu do môi trường và lối sống. Liệu trình dưỡng sáng đa tầng giúp da bừng sáng tự nhiên, đều màu và khỏe khoắn.' },
  ...
  { cat: 'pigment', name: 'Cân bằng sắc tố & Phục hồi sáng', tagline: 'Vừa làm sáng vừa củng cố nền da mỏng yếu vì lột tẩy.', duration: '80 phút', price: '1.100.000đ', priceNote: '/ buổi', summary: 'Nhiều làn da sạm đi kèm mỏng yếu do lạm dụng kem trộn, lột tẩy. Liệu trình kết hợp dưỡng sáng an toàn và phục hồi hàng rào bảo vệ, giúp da vừa sáng vừa khỏe.' },

  /* 4 — Trẻ hóa & Nâng cơ */
  { cat: 'aging', name: 'Trẻ hóa chuyên sâu & Nâng cơ tức thì', tagline: 'Kích hoạt collagen, nâng đỡ đường nét, trả lại độ căng mướt.', duration: '80 phút', price: '1.500.000đ', priceNote: '/ buổi', summary: 'Liệu trình trẻ hóa kết hợp hoạt chất tái cấu trúc và thao tác nâng cơ, cải thiện nếp nhăn, độ đàn hồi và đường viền khuôn mặt — hướng tới vẻ tươi trẻ tự nhiên, không cứng đơ.' },
  { cat: 'aging', name: 'Kích hoạt Collagen chuyên sâu', tagline: 'Thúc đẩy sản sinh collagen, tăng đàn hồi từ tầng sâu.', duration: '85 phút', price: '1.600.000đ', priceNote: '/ buổi', summary: 'Tập trung kích hoạt nguyên bào sợi sản sinh collagen tự nhiên, giúp da dày dặn, đàn hồi và căng mướt hơn theo thời gian — nền tảng của trẻ hóa bền vững.' },
  { cat: 'aging', name: 'Chăm sóc vùng mắt & Rãnh nhăn', tagline: 'Giảm bọng mắt, quầng thâm và nếp nhăn vùng mắt.', duration: '50 phút', price: '700.000đ', priceNote: '/ buổi', summary: 'Vùng da mắt mỏng manh và lão hóa sớm nhất. Liệu trình chuyên biệt giúp giảm bọng mắt, làm sáng quầng thâm và làm mờ nếp nhăn li ti quanh mắt.' },
  { cat: 'aging', name: 'Săn chắc & Định hình đường viền', tagline: 'Nâng đỡ vùng má, hàm, cằm cho gương mặt gọn gàng.', duration: '80 phút', price: '1.700.000đ', priceNote: '/ buổi', summary: 'Liệu trình nâng cơ và săn chắc tập trung vào đường viền khuôn mặt — má, hàm, cằm — giúp gương mặt thon gọn, đường nét rõ ràng và trẻ trung hơn.' },
  { cat: 'aging', name: 'Trẻ hóa cấp nước Glow', tagline: 'Bơm ẩm chuyên sâu, trả lại làn da căng bóng tươi trẻ.', duration: '70 phút', price: '1.200.000đ', priceNote: '/ buổi', summary: 'Da thiếu nước là nguyên nhân khiến nếp nhăn lộ rõ. Liệu trình cấp nước đa tầng giúp da căng mọng, mịn màng và bừng sáng tức thì cho vẻ trẻ trung.' },

  /* 5 — Phục hồi & Chuyên sâu */
  { cat: 'recovery', name: 'Phục hồi hàng rào bảo vệ da', tagline: 'Tái thiết màng lipid, trả lại làn da khỏe từ gốc.', duration: '75 phút', price: '900.000đ', priceNote: '/ buổi', summary: 'Mọi làn da khỏe đều bắt đầu từ một hàng rào bảo vệ vững chắc. Liệu trình tái thiết màng lipid, cấp ẩm và làm dịu, giúp da giữ nước tốt và bớt nhạy cảm.' },
  ...
  { cat: 'recovery', name: 'Phục hồi sau laser & Treatment', tagline: 'Chăm sóc đúng cách giúp da hồi phục nhanh, hạn chế thâm.', duration: '60 phút', price: '800.000đ', priceNote: '/ buổi', summary: 'Sau các thủ thuật laser, peel hay treatment mạnh, da cần được chăm sóc đúng cách. Liệu trình cấp ẩm, làm dịu và phục hồi giúp da hồi phục nhanh, hạn chế thâm và kích ứng.' },
  { cat: 'recovery', name: 'Cấp nước chuyên sâu Hydra', tagline: 'Bù nước đa tầng cho làn da khô căng, mất nước.', duration: '65 phút', price: '750.000đ', priceNote: '/ buổi', summary: 'Da mất nước gây bong tróc, sạm và lão hóa sớm. Liệu trình cấp nước chuyên sâu bổ sung độ ẩm đa tầng, trả lại làn da mềm mướt, căng khỏe.' },
  { cat: 'recovery', name: 'Giảm mẩn đỏ & Mao mạch', tagline: 'Làm dịu vùng đỏ, giảm lộ mao mạch trên da mỏng.', duration: '70 phút', price: '900.000đ', priceNote: '/ buổi', summary: 'Da mỏng dễ lộ mao mạch và ửng đỏ. Liệu trình củng cố thành mạch, làm dịu và phục hồi giúp giảm tình trạng đỏ, mang lại nền da đều màu và khỏe hơn.' },

  /* 6 — Chăm sóc & Thư giãn */
  { cat: 'care', name: 'Chăm sóc da mặt thư giãn', tagline: 'Làm sạch, dưỡng và massage thư giãn định kỳ.', duration: '60 phút', price: '450.000đ', priceNote: '/ buổi', summary: 'Liệu trình chăm sóc da định kỳ giúp làm sạch, dưỡng ẩm và thư giãn. Kết hợp massage nhẹ nhàng giúp da và tinh thần được thả lỏng sau những ngày bận rộn.' },
  { cat: 'care', name: 'Làm sạch sâu & Detox da', tagline: 'Đánh bay bụi mịn, bã nhờn tích tụ, trả lại da thông thoáng.', duration: '65 phút', price: '550.000đ', priceNote: '/ buổi', summary: 'Bụi mịn và bã nhờn tích tụ khiến da xỉn màu, bít tắc. Liệu trình làm sạch sâu và detox giúp da thông thoáng, hấp thu dưỡng chất tốt hơn và tươi sáng hơn.' },
  { cat: 'care', name: 'Đắp mặt nạ dưỡng chuyên sâu', tagline: 'Bổ sung dưỡng chất tập trung theo nhu cầu làn da.', duration: '50 phút', price: '400.000đ', priceNote: '/ buổi', summary: 'Liệu trình đắp mặt nạ chuyên sâu được chọn theo nhu cầu da: cấp ẩm, làm dịu, dưỡng sáng hay phục hồi — bổ sung dưỡng chất tập trung cho làn da rạng rỡ.' },
  { cat: 'care', name: 'Massage nâng cơ thư giãn', tagline: 'Massage dẫn lưu, thư giãn cơ mặt và giảm căng thẳng.', duration: '55 phút', price: '500.000đ', priceNote: '/ buổi', summary: 'Kỹ thuật massage dẫn lưu bạch huyết và nâng cơ giúp giảm sưng, thư giãn cơ mặt và mang lại cảm giác dễ chịu, đồng thời hỗ trợ đường nét gương mặt thon gọn.' },
  { cat: 'care', name: 'Gói chăm sóc da cô dâu', tagline: 'Lộ trình giúp làn da rạng rỡ nhất cho ngày trọng đại.', duration: 'Lộ trình nhiều buổi', price: 'Theo lộ trình', priceNote: 'tư vấn riêng', summary: 'Một lộ trình chăm sóc được thiết kế riêng cho cô dâu, kết hợp điều trị và chăm sóc chuyên sâu nhiều buổi để làn da đạt trạng thái rạng rỡ, mịn màng nhất cho ngày trọng đại.' },
];

const categories = Object.values(CAT_DEFAULTS).map((c) => ({ name: c.name, icon: c.icon }));

const services = RAW_SERVICES.map((s) => {
